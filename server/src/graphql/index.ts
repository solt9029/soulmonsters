...
export enum ActionType {
    ...
    EFFECT_FRESH_FISH_DRAW = "EFFECT_FRESH_FISH_DRAW",
    EFFECT_NATSUKASHINORUDE_POWER_DOWN = "EFFECT_NATSUKASHINORUDE_POWER_DOWN",
    EFFECT_EMERALD_ENERGY_INCREASE = "EFFECT_EMERALD_ENERGY_INCREASE",
    EFFECT_SUPERNEWVOLTS_DESTROY_MONSTER = "EFFECT_SUPERNEWVOLTS_DESTROY_MONSTER",
    EFFECT_SPEED_DRAGON_BIRD_CHANGE_POSITION = "EFFECT_SPEED_DRAGON_BIRD_CHANGE_POSITION",
    SELECT_AS_HAMONTAKI_TARGET = "SELECT_AS_HAMONTAKI_TARGET",
    USE_HEDRON = "USE_HEDRON",
    SELECT_AS_HEDRON_TARGET = "SELECT_AS_HEDRON_TARGET"
}
...
export enum EffectType {
    SOUL_CANON = "SOUL_CANON",
    SOUL_BARRIER = "SOUL_BARRIER",
    RUTERUTE_DRAW = "RUTERUTE_DRAW",
    FRESH_FISH_DRAW = "FRESH_FISH_DRAW",
    NATSUKASHINORUDE_POWER_DOWN = "NATSUKASHINORUDE_POWER_DOWN",
    EMERALD_ENERGY_INCREASE = "EMERALD_ENERGY_INCREASE",
    SUPERNEWVOLTS_DESTROY_MONSTER = "SUPERNEWVOLTS_DESTROY_MONSTER",
    SPEED_DRAGON_BIRD_CHANGE_POSITION = "SPEED_DRAGON_BIRD_CHANGE_POSITION",
    SHIMASHIMAJUNIOR_ENERGY_TRANSFER = "SHIMASHIMAJUNIOR_ENERGY_TRANSFER",
    SHINKASHITABAKUBOMDAN_DAMAGE = "SHINKASHITABAKUBOMDAN_DAMAGE",
    AIKAWARAZUYOKUWAKARANAIHANA_DAMAGE = "AIKAWARAZUYOKUWAKARANAIHANA_DAMAGE",
    NISEKISANCHOU_ENERGY_INCREASE = "NISEKISANCHOU_ENERGY_INCREASE",
    SAIFUKKATSUSHITATAKIBEE_DAMAGE = "SAIFUKKATSUSHITATAKIBEE_DAMAGE",
    REITETSUNATOTI_DRAW = "REITETSUNATOTI_DRAW",
    HAMONTAKI_SPECIAL_SUMMON = "HAMONTAKI_SPECIAL_SUMMON",
    HEDRON_SPECIAL_SUMMON = "HEDRON_SPECIAL_SUMMON"
}
...
export enum StateType {
    ...
    EFFECT_FRESH_FISH_DRAW_COUNT = "EFFECT_FRESH_FISH_DRAW_COUNT",
    EFFECT_NATSUKASHINORUDE_POWER_DOWN = "EFFECT_NATSUKASHINORUDE_POWER_DOWN",
    EFFECT_EMERALD_ENERGY_INCREASE_COUNT = "EFFECT_EMERALD_ENERGY_INCREASE_COUNT",
    EFFECT_SUPERNEWVOLTS_DESTROY_MONSTER_COUNT = "EFFECT_SUPERNEWVOLTS_DESTROY_MONSTER_COUNT"
}
